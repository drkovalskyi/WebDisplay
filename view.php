			...
			<?php if(! empty($data['directoryTree'])): ?>
				<div class="row">
                  ...
                  <a href=<?php echo $directoryUrl."index.php?dir=$url"; ?>>
						...
						<?php endforeach; ?>
              <li>
                <a href=<?php echo str_replace('view','index',"http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]");?> >
                  [browse directory]
                </a>
              </li>
						</ul>
                  ...
                  <?php if ($file['mime']=='image/png'): ?>
                    <?php if (preg_match("/" . $regex . "/",$file['name'])): ?>
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          ...
                          <br>
                          <a href="<?php echo str_replace('png','pdf',$file['url']); ?>" target="<?php echo $file['target']; ?>" > 
                            <img style="width:100%" src="<?php echo $file['url']; ?>" target="<?php echo $file['target']; ?>" >
                          </a>
                        </div>
                    <?php endif; ?>
                  <?php endif; ?>
